...
public class no {
    ...
    public static void main(String[] args) {
        ...
        if (mongo != null) {
            ...
            while (cur.hasNext()) {
                System.out.println(" - " + cur.next().get("nombre") + " " + cur.curr().get("apellidos") + " -- "
                        + cur.curr().get("anyos") + " años (" + cur.curr().get("fecha") + ")");
            }
            System.out.println();
            ...
            while (cur2.hasNext()) {
                System.out.println(" - " + cur2.next().get("nombre") + " " + cur2.curr().get("apellidos") + " -- "
                        + cur2.curr().get("anyos") + " años (" + cur2.curr().get("fecha") + ")");
            }
            System.out.println();
            ...
            while (cur3.hasNext()) {
                System.out.println(" - " + cur3.next().get("nombre") + " " + cur3.curr().get("apellidos") + " -- "
                        + cur3.curr().get("anyos") + " años (" + cur3.curr().get("fecha") + ")");
            }
            System.out.println();
            ...
            // Set tablesList = db.getCollectionNames();
            // for (Iterator iterator = tablesList.iterator(); iterator.hasNext();) {
