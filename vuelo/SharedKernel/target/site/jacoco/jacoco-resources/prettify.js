...
(function () {
  ...
  function recombineTagsAndDecorations(job) {
    ...
    if (numberLines) {
      ...
      var lineNum =
        numberLines[1] && numberLines[1].length ? numberLines[1] - 1 : 0; // Lines are 1-indexed
      ...
      lineBreaker = function () {
        ...
        return openDecoration
          ? "</span>" + lb + '<span class="' + openDecoration + '">'
          : lb;
      };
    } else {
