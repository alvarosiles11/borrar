...
public class CrearTripulanteHandlerTest {
	ITripulanteFactory _ITripulanteFactory = Mockito.mock(ITripulanteFactory.class);
	...
	public void HandleCorrectly() throws HttpException {
		...
		when(_ITripulanteFactory.Create(keyVuelo, keyTripulante, cargo)).thenReturn(tripulante);

		CrearTripulanteHandler handler = new CrearTripulanteHandler(_ITripulanteFactory, _ITripulanteRepository,
				_IUnitOfWork);
