...
public class CrearAeronaveHandlerTest {
	...
	IAeronaveRepository _IAeronaveRepository = Mockito.mock(IAeronaveRepository.class);
	...
	public void HandleCorrectly() throws HttpException {
		...
		CrearAeronaveHandler handler = new CrearAeronaveHandler(_IAeronaveFactory, _IAeronaveRepository, _IUnitOfWork);
